...
const ApiKeyScreen: React.FC<ApiKeyScreenProps> = ({ apiKey, onSave }) => {
  ...
  return (
    <div className="flex flex-col h-full px-4 items-center justify-center">
      <div className="w-full max-w-sm bg-gray-900 rounded-xl border border-gray-800 shadow-md p-6">
        ...
        <div className="mb-4 p-3 bg-blue-500 bg-opacity-20 border border-blue-500 rounded text-blue-300 text-sm flex items-start">
          ...
          <p>
            API key is stored locally and never sent to any servers. Making all
            the requests to Models's endpoint with your API Key.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <p className="mt-1 text-xs text-gray-400">
              Get your API key from your Model Provider: Gemini, ChatGPT, Claude
            </p>
          </div>
        ...
        <div className="mt-6">
          ...
          <p className="text-sm text-gray-400">
            LeetAI uses the API to make requests on your behalf, giving you full
            control over cost and usage. The API key is stored locally, and
