    ...
    <div className="flex flex-col h-full px-4 items-center justify-center">
      <div className="w-full max-w-sm bg-gray-900 rounded-xl border border-gray-800 shadow-md p-6">
        ...
        <div className="mb-4 p-3 bg-blue-500 bg-opacity-20 border border-blue-500 rounded text-blue-300 text-sm flex items-start">
          ...
          <p>
            API key is stored locally and never sent to any servers. Only used
            while making requests to Gemini API endpoint.
          </p>
        </div>
        ...
        <div className="mt-6">
          ...
          <p className="text-sm text-gray-400">
            LeetAI uses the Gemini API to make requests on your behalf, giving
            you full control over cost and usage. The API key is stored locally,
            further increasing security. Feel free to check the GitHub repo for
            more details.
          </p>
        </div>
      </div>
